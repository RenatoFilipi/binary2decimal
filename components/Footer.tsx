  ...
  return (
    <>
      <footer className="p-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6">
        <span className="text-sm text-gray-800 sm:text-center font-qs">
          Made by{" "}
          <Link
            href="https://www.linkedin.com/in/renato-filipi-silva-rosa-61277b138/"
            passHref
          >
            <a
              target="_blank"
          ...
          <li>
            ...
            >
              <a
                target="_blank"
                rel="noopener noreferrer"
                className="mr-4 md:mr-6 font-qs flex gap-2"
              >
                <svg
